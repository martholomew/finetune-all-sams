...
#from segment_anything_fast.modeling.sam import Sam
...
class LoRA_sam(nn.Module):
    ...
    def __init__(self, sam_model, rank: int, lora_layer=None):
        ...
        for layer in sam_model.image_encoder.layers:
        ...
        if lora_layer:
            ...
            self.lora_layer = list(range(len(all_blocks)))
        ...
        for t_layer_i, blk in enumerate(all_blocks):
